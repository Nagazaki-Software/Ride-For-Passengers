          ...
          children: [
            StreamBuilder<List<UsersRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<UsersRecord> hybridRideMapUsersRecordList = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((_model.textController.text == '') ||
                              !(_model.locationPerto != null &&
                                  (_model.locationPerto)!.isNotEmpty))
                            Align(
                              alignment: AlignmentDirectional(-1.0, -1.0),
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(

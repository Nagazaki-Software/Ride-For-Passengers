...
import 'chat_support_model.dart';
export 'chat_support_model.dart';

/// crie uma pagina de conversar com outro usuario
...
class _ChatSupportWidgetState extends State<ChatSupportWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'chatSupport'});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0x8817181D),
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CHAT_SUPPORT_chevron_left_ICN_ON_TAP');
          ...
          title: Row(
            ...
            children: [
              Container(
                ...
                child: Image.asset(
                  'assets/images/Imagem_do_WhatsApp_de_2025-09-18_(s)_03.50.16_fe83378b.jpg',
                  fit: BoxFit.cover,
                ),
              ),
              Column(
                ...
                builder: (context, snapshot) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children:
                          List.generate(columnChatHistoryRecordList.length,
                                  (columnIndex) {
                        final columnChatHistoryRecord =
                            columnChatHistoryRecordList[columnIndex];
                        return Builder(
                          builder: (context) {
                            if ((columnChatHistoryRecord.documentUser ==
                                    currentUserReference) &&
                                !columnChatHistoryRecord.msgdosystema) {
                              return Row(
                                mainAxisSize: MainAxisSize.max,
                            ...
                            } else if ((columnChatHistoryRecord.documentUser ==
                                    null) &&
                                columnChatHistoryRecord.msgdosystema) {
                              return Text(
                                columnChatHistoryRecord.msg,
                ...
                child: Row(
                  ...
                  children: [
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'CHAT_SUPPORT_photo_library_rounded_ICN_O');
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataZuu = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataZuu = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataZuu =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataZuu =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
                        ...
                        await ChatHistoryRecord.createDoc(widget.chat!)
                            .set(createChatHistoryRecordData(
                          horario: getCurrentTimestamp,
                          foto: _model.uploadedFileUrl_uploadDataZuu,
                        ));
                      },
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (_) async {
                          logFirebaseEvent(
                              'CHAT_SUPPORT_TextField_12qsgxs0_ON_TEXTF');
                    ...
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'CHAT_SUPPORT_PAGE_IconButtonSend_ON_TAP');

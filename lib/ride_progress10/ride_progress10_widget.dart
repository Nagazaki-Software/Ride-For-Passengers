...
class RideProgress10Widget extends StatefulWidget {
  const RideProgress10Widget({super.key});

  static String routeName = 'RideProgress10';
  static String routePath = '/rideProgress10';

  @override
  State<RideProgress10Widget> createState() => _RideProgress10WidgetState();
}

class _RideProgress10WidgetState extends State<RideProgress10Widget> {
  late RideProgress10Model _model;

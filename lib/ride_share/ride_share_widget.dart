...
import 'ride_share_model.dart';
export 'ride_share_model.dart';

class RideShareWidget extends StatefulWidget {
  const RideShareWidget({super.key});

  static String routeName = 'RideShare';
  static String routePath = '/rideShare';

  @override
  State<RideShareWidget> createState() => _RideShareWidgetState();
}

class _RideShareWidgetState extends State<RideShareWidget> {
  late RideShareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RideShareModel());
  }

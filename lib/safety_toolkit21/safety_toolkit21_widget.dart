...
class SafetyToolkit21Widget extends StatefulWidget {
  const SafetyToolkit21Widget({super.key});

  static String routeName = 'SafetyToolkit21';
  static String routePath = '/safetyToolkit21';

  @override
  State<SafetyToolkit21Widget> createState() => _SafetyToolkit21WidgetState();
}

class _SafetyToolkit21WidgetState extends State<SafetyToolkit21Widget>
    with TickerProviderStateMixin {
  late SafetyToolkit21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SafetyToolkit21Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SafetyToolkit21'});
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SAFETY_TOOLKIT21_ContainerAddContact_ON_');
                                          logFirebaseEvent(
                                              'ContainerAddContact_widget_animation');
                                          if (animationsMap[
                                          ...
                                          logFirebaseEvent(
                                              'ContainerAddContact_bottom_sheet');
                                ...
                                AuthUserStreamWidget(
                                  builder: (context) => Builder(
                                    builder: (context) {
                                      final contacts = (currentUserDocument
                                                  ?.emergencyContacts
                                                  .toList() ??
                                              [])
                                          .toList();
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      SwitchsafetoolkitWidget(
                                                        key: Key(
                                                            'Keydlw_${contactsIndex}_of_${contacts.length}'),
                                                      ),
                                                    ],
                                                  ),
                                                ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SAFETY_TOOLKIT21_ContainerSave_ON_TAP');
                                        logFirebaseEvent(
                                            'ContainerSave_backend_call');

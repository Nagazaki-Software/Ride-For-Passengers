...
class _Home5WidgetState extends State<Home5Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Home5'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('HOME5_PAGE_Home5_ON_INIT_STATE');
      currentUserLocationValue =
          await getCurrentUserLocation(defaultLocation: LatLng(0.0, 0.0));
      logFirebaseEvent('Home5_custom_action');
      ...
      logFirebaseEvent('Home5_update_app_state');
              ...
              children: [
                Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 14.0, 0.0, 6.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Padding(
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOME5_PAGE_Container_qmszxcbk_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(pertos.length,
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'HOME5_PAGE_Container_v5196x87_ON_TAP');
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME5_PAGE_ContainerDate_ON_TAP');
                                                logFirebaseEvent(
                                                    'ContainerDate_date_time_picker');
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME5_PAGE_ContainerPassangers_ON_TAP');
                                                logFirebaseEvent(
                                                    'ContainerPassangers_widget_animation');
                                                if (animationsMap[
                                                ...
                                                if (FFAppState().passangers ==
                                                    8) {
                                                  logFirebaseEvent(
                                                      'ContainerPassangers_update_app_state');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'HOME5_PAGE_ContainerRide_ON_TAP');
                                              if (_model.rideChoose == 'ride') {
                                                logFirebaseEvent(
                                                    'ContainerRide_widget_animation');
                                                if (animationsMap[
                                                ...
                                                logFirebaseEvent(
                                                    'ContainerRide_update_page_state');
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'HOME5_PAGE_ContainerXL_ON_TAP');
                                              if (_model.rideChoose == 'xl') {
                                                logFirebaseEvent(
                                                    'ContainerXL_widget_animation');
                                                if (animationsMap[
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'HOME5_PAGE_ContainerLuxury_ON_TAP');
                                              if (_model.rideChoose ==
                                                  'luxury') {
                                                logFirebaseEvent(
                                                    'ContainerLuxury_widget_animation');
                                                if (animationsMap[
                                                ...
                                                logFirebaseEvent(
                                                    'ContainerLuxury_update_page_state');
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'HOME5_PAGE_ContainerConfirmRide_ON_TAP');
                                            currentUserLocationValue =
                                                await getCurrentUserLocation(
                                                    defaultLocation:
                                                        LatLng(0.0, 0.0));
                                            logFirebaseEvent(
                                                'ContainerConfirmRide_widget_animation');
                                            if (animationsMap[
                                            ...
                                            logFirebaseEvent(
                                                'ContainerConfirmRide_firestore_query');
                                            _model.order =
                                                await queryRideOrdersRecordOnce();
                                            logFirebaseEvent(
                                                'ContainerConfirmRide_navigate_to');
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'HOME5_PAGE_ContainerRideShare_ON_TAP');
                                            logFirebaseEvent(

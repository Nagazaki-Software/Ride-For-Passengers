...
import 'component_schedule_action_copy_model.dart';
export 'component_schedule_action_copy_model.dart';

class ComponentScheduleActionCopyWidget extends StatefulWidget {
  const ComponentScheduleActionCopyWidget({
    super.key,
    required this.order,
  });
  ...
  @override
  State<ComponentScheduleActionCopyWidget> createState() =>
      _ComponentScheduleActionCopyWidgetState();
}

class _ComponentScheduleActionCopyWidgetState
    extends State<ComponentScheduleActionCopyWidget>
    with TickerProviderStateMixin {
  late ComponentScheduleActionCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentScheduleActionCopyModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'COMPONENT_SCHEDULE_ACTION_COPY_Container');
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      () {
                                        if (FFAppState().locationAondeEleEsta !=
                                                '') {
                                          return FFAppState()
                                              .locationAondeEleEsta;
                                                    ...
                                                    .nomeOrigem !=
                                                '') {
                                          return containerRideOrdersRecord
                                              .nomeOrigem;
                                        } else {
                                          return 'Bay Street 14';
                                        }
                                      }(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      () {
                                        if (FFAppState().locationWhereTo !=
                                                '') {
                                          return FFAppState().locationWhereTo;
                                        } else if (containerRideOrdersRecord
                                                    .nomeDestino !=
                                                '') {
                                          return containerRideOrdersRecord
                                          ...
                                          return 'Lynden Pindling Airport';
                                        }
                                      }(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium

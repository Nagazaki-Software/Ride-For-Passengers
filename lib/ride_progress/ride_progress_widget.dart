...
import 'ride_progress_model.dart';
export 'ride_progress_model.dart';

class RideProgressWidget extends StatefulWidget {
  const RideProgressWidget({super.key});

  static String routeName = 'RideProgress';
  static String routePath = '/rideProgress';
...
class _RideProgressWidgetState extends State<RideProgressWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RideProgressModel());
  }

...
class CreateProfile2CopyWidget extends StatefulWidget {
  const CreateProfile2CopyWidget({
    super.key,
    required this.quickyPlataform,
  });

  final String? quickyPlataform;

  static String routeName = 'CreateProfile2Copy';
  static String routePath = '/createProfile2Copy';

  @override
  State<CreateProfile2CopyWidget> createState() =>
                              ...
                              child: Stack(
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/ChatGPT_Image_15_de_ago._de_2025,_15_38_16.png',

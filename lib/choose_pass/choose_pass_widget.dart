...
import 'choose_pass_model.dart';
export 'choose_pass_model.dart';

class ChoosePassWidget extends StatefulWidget {
  const ChoosePassWidget({super.key});

  static String routeName = 'ChoosePass';
  static String routePath = '/choosePass';

  @override
  State<ChoosePassWidget> createState() => _ChoosePassWidgetState();
}

class _ChoosePassWidgetState extends State<ChoosePassWidget>
    with TickerProviderStateMixin {
  late ChoosePassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoosePassModel());
